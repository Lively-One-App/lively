...
mixin _$AzuraApiNowPlayingStationMount {
  ...
  @JsonKey(ignore: true)
  $AzuraApiNowPlayingStationMountCopyWith<AzuraApiNowPlayingStationMount>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AzuraApiNowPlayingStationMountCopyWith<$Res> {
...
class _$_AzuraApiNowPlayingStationMount
  ...
  @override
  String toString() {
    return 'AzuraApiNowPlayingStationMount(path: $path, isDefault: $isDefault, id: $id, name: $name, url: $url, bitrate: $bitrate, format: $format, listeners: $listeners)';
  }
