...
mixin _$AzuraApiNowPlayingStationRemote {
  ...
  @JsonKey(ignore: true)
  $AzuraApiNowPlayingStationRemoteCopyWith<AzuraApiNowPlayingStationRemote>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AzuraApiNowPlayingStationRemoteCopyWith<$Res> {
...
class _$_AzuraApiNowPlayingStationRemote
  ...
  @override
  String toString() {
    return 'AzuraApiNowPlayingStationRemote(id: $id, name: $name, url: $url, bitrate: $bitrate, format: $format, listeners: $listeners)';
  }
